...
function Home() {
  ...
  return (
    <>
   <section>
    <h2 className='text-center font-bold text-4xl py-10   text-red-700' >Celebration wear for Men  {count}</h2>
      {/*<button onClick = {()=>addData(10, 20)} className=' block mx-auto p-3 bg-red-400 text-white mb-4'>Add data</button>*/}
    <button onClick = {changeCount} className=' block mx-auto p-3 bg-red-400 text-white mb-4'>Change Count</button>
    <p className='text-center mb-4'>Welcome to Men wear shop to see and shop the most demanded designs</p>

    <div className='max-w-[1320] mx-auto grid grid-cols-4 gap-5' >
        <ProductCard/>
         <ProductCard/>
        <ProductCard/>
        <ProductCard/>
   ...
   <section>
    <h2 className='text-center font-bold text-4xl py-10' >Celebration wear for Women</h2>
    <p className='text-center'>Welcome to Women wear shop to see and shop the most demanded designs</p>
